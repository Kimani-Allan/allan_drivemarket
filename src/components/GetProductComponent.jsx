...
const GetProductComponent = () => {
    ...
    const getProducts = async () => {
        ...
        try {
            const response = await axios.get("https://allank.alwaysdata.net/api/get_products");
                    ...
                    <div className="col-md-3 justify-content-center mb-4">
                        <div className="card shadow card-margin">
                            ...
                            <div className="card-body">
                                ...
                                <br /> <br />
                                <button className="btn btn-success" onClick={() => { navigator("/makepayment", { state: { product } }); }}>Purchase now!!!</button>
                            </div>
                        </div>
                    </div>
                ))}
